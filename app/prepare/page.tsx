...
const METHODS = [
  {
    ...
    equipment: ['Френч-пресс', 'Молотый Данлеон (грубый помол)', 'Вода 92–96 °С', 'Весы'],
    steps: [
  ...
  },
  {
    ...
    equipment: ['Дриппер V60', 'Бумажный фильтр', 'Молотый Данлеон (средний помол)', 'Чайник-гусятник', 'Весы'],
    steps: [
  ...
  },
  {
    ...
    equipment: ['Аэропресс + фильтр', 'Молотый Данлеон (средне-мелкий помол)', 'Вода 92–96 °С'],
    steps: [
  ...
  },
  {
    ...
    equipment: ['Турка (джезва)', 'Молотый Данлеон (мелкий помол «в пыль»)', 'Холодная фильтрованная вода'],
    steps: [
  ...
  },
  {
    ...
    equipment: ['Гейзерная кофеварка', 'Молотый Данлеон (мелкий помол)', 'Горячая вода'],
    steps: [

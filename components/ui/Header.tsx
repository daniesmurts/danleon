        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <div className="flex items-center gap-4">
              {/* Admin shortcut — only visible to users with admin claim */}
              {isAdmin && (
                <Link
                  href="/admin"
                  className="hidden md:flex items-center gap-1 font-heading text-[10px] tracking-widest uppercase text-cream/40 hover:text-cream transition-colors"
                >
